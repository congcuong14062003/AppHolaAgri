...
public class MonitoringClosestValueFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_monitoring_closest_value, container, false);
        // Ánh xạ View
        ...
        if (getArguments() != null) {
            monitoringId = getArguments().getInt("monitoringId", -1);
            Log.d("MonitoringClosestValueFragment", "monitoringId:" + monitoringId );
