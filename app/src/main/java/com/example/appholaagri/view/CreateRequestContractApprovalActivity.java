...
public class CreateRequestContractApprovalActivity extends AppCompatActivity {
    private EditText edt_name_request_create, edt_name_employye_request_create, edt_part_request_create,
            ...
            edt_partner_name_request_create, edt_contract_type_request_create, edt_content_request_create;
    ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_request_contract_approval);
...
// công ty
        ...
        edt_partner_name_request_create = findViewById(R.id.edt_partner_name_request_create);
        edt_contract_type_request_create = findViewById(R.id.edt_contract_type_request_create);
        ...
        discussionAdapter.setOnFileStatusChangedListener((file, filePosition, commentPosition) -> {
            if (requestDetailData != null && requestDetailData.getComments() != null &&
                ...
                if (originalFiles != null && filePosition < originalFiles.size()) {
                    ...
                    Log.d("CreateRequestContractApprovalActivity", "Updated status in requestDetailData for file: " + file.getName() +
        ...
        ivSend.setOnClickListener(v -> {
            ...
            if (content.isEmpty()) {
                CustomToast.showCustomToast(CreateRequestContractApprovalActivity.this, "Vui lòng nhập nội dung thảo luận");
                return;
            }
        ...
        edt_follower_request_create.setOnClickListener(view -> {
            Intent intent1 = new Intent(CreateRequestContractApprovalActivity.this, SelectFollowerActivity.class);
    ...
    private void getInitFormCreateRequest(String token, int GroupRequestId) {
        ...
        call.enqueue(new Callback<ApiResponse<RequestDetailData>>() {
                ...
                try {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (apiResponse.getStatus() == 200) {
                            ...
                            CustomToast.showCustomToast(CreateRequestContractApprovalActivity.this, apiResponse.getMessage());
                        }
                    } else {
                        CustomToast.showCustomToast(CreateRequestContractApprovalActivity.this, "Lỗi kết nối, vui lòng thử lại.");
                    }
                } catch (Exception e) {
                    Log.e("CreateRequestContractApprovalActivity", "Error: " + e.getMessage());
                    CustomToast.showCustomToast(CreateRequestContractApprovalActivity.this, "Có lỗi xảy ra. Vui lòng thử lại.");
                }
            }
            ...
            public void onFailure(Call<ApiResponse<RequestDetailData>> call, Throwable t) {
                hideLoading();
                CustomToast.showCustomToast(CreateRequestContractApprovalActivity.this, "Lỗi: " + t.getMessage());
            }
        });
    }
    ...
    private void updateUserUI(RequestDetailData requestDetailData) {
        try {
            if (requestDetailData == null) {
                Log.e("CreateRequestContractApprovalActivity", "requestDetailData is null");
                return;
            }
            Gson gson = new GsonBuilder().setPrettyPrinting().serializeNulls().create();
            String requestDetailDataJson = gson.toJson(requestDetailData);
            Log.d("CreateRequestContractApprovalActivity", "dataa chi tiết: " + requestDetailDataJson);
            ...
            if (requestDetailData.getCustomerContractReq() != null) {
                edt_partner_name_request_create.setText(requestDetailData.getCustomerContractReq().getCustomerName());
                edt_contract_type_request_create.setText(requestDetailData.getCustomerContractReq().getCustomerContract().getName());
                edt_content_request_create.setText(requestDetailData.getCustomerContractReq().getNote());
            }
            ...
            Log.e("CreateRequestContractApprovalActivity", "Error updating UI: " + e.getMessage());
        }
    }
    ...
    public void handleCreateRequest(RequestDetailData requestDetailData, ListStatus listStatus) {
        ...
        Gson gson = new GsonBuilder().setPrettyPrinting().serializeNulls().create();
        Log.d("CreateRequestContractApprovalActivity", "Data: " + gson.toJson(requestDetailData));
            ...
            call.enqueue(new Callback<ApiResponse<String>>() {
                ...
                public void onResponse(Call<ApiResponse<String>> call, Response<ApiResponse<String>> response) {
                    ...
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        CustomToast.showCustomToast(CreateRequestContractApprovalActivity.this, apiResponse.getMessage());
                        if (apiResponse.getStatus() == 200) {
                            Intent intent = new Intent(CreateRequestContractApprovalActivity.this, HomeActivity.class);
    ...
    private void showRejectReasonDialog(ApiInterface apiInterface, String token, RequestDetailData requestDetailData) {
        ...
        btn_confirm.setOnClickListener(view -> {
            ...
            if (!reason.isEmpty()) {
                ...
                CustomToast.showCustomToast(CreateRequestContractApprovalActivity.this, "Vui lòng nhập lý do");
            }
        });
            ...
            public void onResponse(Call<ApiResponse<UploadFileResponse>> call, Response<ApiResponse<UploadFileResponse>> response) {
                if (response.isSuccessful() && response.body() != null && response.body().getStatus() == 200) {
                    ...
                    if (uploadResponse.getFinalStatus() == 200) {
                        ...
                        hideLoading();
                        CustomToast.showCustomToast(CreateRequestContractApprovalActivity.this, "Lỗi tải file: " + uploadResponse.getMessage());
                    }
                } else {
                    hideLoading();
                    CustomToast.showCustomToast(CreateRequestContractApprovalActivity.this, "Lỗi server: " + response.message());
                }
            }
...
//        comment.setRequestId(requestId);
        ...
        Log.d("CreateRequestContractApprovalActivity", "Datacomment: " + requestData);
        ApiInterface apiInterface = ApiClient.getClient(this).create(ApiInterface.class);
