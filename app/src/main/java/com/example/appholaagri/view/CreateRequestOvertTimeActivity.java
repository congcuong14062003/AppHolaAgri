...
public class CreateRequestOvertTimeActivity extends BaseActivity {
    ...
    private LinearLayout layout_action_history_request, comment_container, discussion_layout, feature_layout, code_request_layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        discussionAdapter.setOnFileStatusChangedListener((file, filePosition, commentPosition) -> {
            if (requestDetailData != null && requestDetailData.getComments() != null &&
                ...
                if (originalFiles != null && filePosition < originalFiles.size()) {
                    ...
                    Log.d("CreateRequestOvertTimeActivity", "Updated status in requestDetailData for file: " + file.getName() +
        ...
        if (intent != null) {
            ...
            Log.d("CreateRequestOvertTime", "GroupRequestId: " + GroupRequestId);
        }
            ...
            public void onResponse(Call<ApiResponse<UploadFileResponse>> call, Response<ApiResponse<UploadFileResponse>> response) {
                if (response.isSuccessful() && response.body() != null && response.body().getStatus() == 200) {
                    ...
                    if (uploadResponse.getFinalStatus() == 200) {
                        ...
                        hideLoading();
                        CustomToast.showCustomToast(CreateRequestOvertTimeActivity.this, "Lỗi tải file: " + uploadResponse.getMessage());
                    }
                } else {
                    hideLoading();
                    CustomToast.showCustomToast(CreateRequestOvertTimeActivity.this, "Lỗi server: " + response.message());
                }
            }
...
//        comment.setRequestId(requestId);
        ...
        Log.d("CreateRequestOvertTimeActivity", "Datacomment: " + requestData);
        ApiInterface apiInterface = ApiClient.getClient(this).create(ApiInterface.class);
