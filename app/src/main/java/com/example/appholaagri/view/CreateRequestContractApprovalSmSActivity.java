...
public class CreateRequestContractApprovalSmSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_request_contract_approval_sms_sactivity);
...
// công ty
        ...
        discussionAdapter.setOnFileStatusChangedListener((file, filePosition, commentPosition) -> {
            if (requestDetailData != null && requestDetailData.getComments() != null &&
                ...
                if (originalFiles != null && filePosition < originalFiles.size()) {
                    ...
                    Log.d("CreateRequestContractApprovalSmSActivity", "Updated status in requestDetailData for file: " + file.getName() +
        ...
        ivSend.setOnClickListener(v -> {
            ...
            if (content.isEmpty()) {
                CustomToast.showCustomToast(CreateRequestContractApprovalSmSActivity.this, "Vui lòng nhập nội dung thảo luận");
                return;
            }
        ...
        edt_follower_request_create.setOnClickListener(view -> {
            Intent intent1 = new Intent(CreateRequestContractApprovalSmSActivity.this, SelectFollowerActivity.class);
    ...
    private void getInitFormCreateRequest(String token, int GroupRequestId) {
        ...
        call.enqueue(new Callback<ApiResponse<RequestDetailData>>() {
                ...
                try {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (apiResponse.getStatus() == 200) {
                            ...
                            CustomToast.showCustomToast(CreateRequestContractApprovalSmSActivity.this, apiResponse.getMessage());
                        }
                    } else {
                        CustomToast.showCustomToast(CreateRequestContractApprovalSmSActivity.this, "Lỗi kết nối, vui lòng thử lại.");
                    }
                } catch (Exception e) {
                    Log.e("CreateRequestContractApprovalSmSActivity", "Error: " + e.getMessage());
                    CustomToast.showCustomToast(CreateRequestContractApprovalSmSActivity.this, "Có lỗi xảy ra. Vui lòng thử lại.");
                }
            }
            ...
            public void onFailure(Call<ApiResponse<RequestDetailData>> call, Throwable t) {
                hideLoading();
                CustomToast.showCustomToast(CreateRequestContractApprovalSmSActivity.this, "Lỗi: " + t.getMessage());
            }
        });
    }
    ...
    private void updateUserUI(RequestDetailData requestDetailData) {
        try {
            if (requestDetailData == null) {
                Log.e("CreateRequestContractApprovalSmSActivity", "requestDetailData is null");
                return;
            }
            ...
            Log.e("CreateRequestContractApprovalSmSActivity", "Error updating UI: " + e.getMessage());
        }
    }
    ...
    public void handleCreateRequest(RequestDetailData requestDetailData, ListStatus listStatus) {
        ...
        Log.d("CreateRequestContractApprovalSmSActivity", "Data: " + gson.toJson(requestDetailData));
            ...
            call.enqueue(new Callback<ApiResponse<String>>() {
                ...
                public void onResponse(Call<ApiResponse<String>> call, Response<ApiResponse<String>> response) {
                    ...
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        CustomToast.showCustomToast(CreateRequestContractApprovalSmSActivity.this, apiResponse.getMessage());
                        if (apiResponse.getStatus() == 200) {
                            Intent intent = new Intent(CreateRequestContractApprovalSmSActivity.this, HomeActivity.class);
    ...
    private void showRejectReasonDialog(ApiInterface apiInterface, String token, RequestDetailData requestDetailData) {
        ...
        btn_confirm.setOnClickListener(view -> {
            ...
            if (!reason.isEmpty()) {
                ...
                CustomToast.showCustomToast(CreateRequestContractApprovalSmSActivity.this, "Vui lòng nhập lý do");
            }
        });
            ...
            public void onResponse(Call<ApiResponse<UploadFileResponse>> call, Response<ApiResponse<UploadFileResponse>> response) {
                if (response.isSuccessful() && response.body() != null && response.body().getStatus() == 200) {
                    ...
                    if (uploadResponse.getFinalStatus() == 200) {
                        ...
                        hideLoading();
                        CustomToast.showCustomToast(CreateRequestContractApprovalSmSActivity.this, "Lỗi tải file: " + uploadResponse.getMessage());
                    }
                } else {
                    hideLoading();
                    CustomToast.showCustomToast(CreateRequestContractApprovalSmSActivity.this, "Lỗi server: " + response.message());
                }
            }
...
//        comment.setRequestId(requestId);
        ...
        Log.d("CreateRequestContractApprovalSmSActivity", "Datacomment: " + requestData);
        ApiInterface apiInterface = ApiClient.getClient(this).create(ApiInterface.class);
