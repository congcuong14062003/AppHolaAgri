...
public class CreateRequestResignActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        discussionAdapter.setOnFileStatusChangedListener((file, filePosition, commentPosition) -> {
            if (requestDetailData != null && requestDetailData.getComments() != null &&
                ...
                if (originalFiles != null && filePosition < originalFiles.size()) {
                    ...
                    Log.d("CreateRequestResignActivity", "Updated status in requestDetailData for file: " + file.getName() +
        ...
        edt_follower_request_create.setOnClickListener(view -> {
            Intent intent1 = new Intent(CreateRequestResignActivity.this, SelectFollowerActivity.class);
            ...
            public void onResponse(Call<ApiResponse<UploadFileResponse>> call, Response<ApiResponse<UploadFileResponse>> response) {
                if (response.isSuccessful() && response.body() != null && response.body().getStatus() == 200) {
                    ...
                    if (uploadResponse.getFinalStatus() == 200) {
                        ...
                        hideLoading();
                        CustomToast.showCustomToast(CreateRequestResignActivity.this, "Lỗi tải file: " + uploadResponse.getMessage());
                    }
                } else {
                    hideLoading();
                    CustomToast.showCustomToast(CreateRequestResignActivity.this, "Lỗi server: " + response.message());
                }
            }
...
//        comment.setRequestId(requestId);
        ...
        Log.d("CreateRequestResignActivity", "Datacomment: " + requestData);
        ApiInterface apiInterface = ApiClient.getClient(this).create(ApiInterface.class);
