...
public class TimeKeepingManageRefusedAdapter extends RecyclerView.Adapter<TimeKeepingManageRefusedAdapter.ViewHolder> {

    private List<TimeKeepingManageData> timeKeepingDataList;

    public TimeKeepingManageRefusedAdapter(List<TimeKeepingManageData> dataList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (data.getReason() != null && !data.getReason().isEmpty()) {
            ...
            holder.reason_refused_text.setText(data.getReason());
        } else {
